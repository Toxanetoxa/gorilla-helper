...
type RegisterResponse struct {
	...
	Token        string `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`
	RefreshToken string `protobuf:"bytes,4,opt,name=refreshToken,proto3" json:"refreshToken,omitempty"`
	MailSent     bool   `protobuf:"varint,5,opt,name=mailSent,proto3" json:"mailSent,omitempty"`
}
...
func (x *RegisterResponse) GetMailSent() bool {
	if x != nil {
		return x.MailSent
	}
	return false
...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0x9c, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x61, 0x69, 0x6c, 0x53, 0x65,
	0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x6d, 0x61, 0x69, 0x6c, 0x53, 0x65,
	0x6e, 0x74, 0x22, 0x25, 0x0a, 0x0d, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x44, 0x0a, 0x0e, 0x56, 0x65, 0x72,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x84, 0x01, 0x0a, 0x14, 0x52,
	...
	0x32, 0xc5, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x0b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x13, 0x2e, 0x61,
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x6f, 0x78, 0x61, 0x6e, 0x65, 0x74, 0x6f, 0x78,
	0x61, 0x2f, 0x67, 0x6f, 0x72, 0x69, 0x6c, 0x6c, 0x61, 0x2d, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x70,
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.VerifyEmail:input_type -> auth.VerifyRequest
	...
	5, // 7: auth.AuthService.VerifyEmail:output_type -> auth.VerifyResponse
